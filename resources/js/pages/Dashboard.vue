    ...
    <AppLayout title="Dashboard">
        ...
        <div class="max-md:order-1 lg:w-5/12">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="/" class="btn text-lg uppercase"> <i class="fas fa-book mr-4 text-xl"></i> Guides </a>
                <a href="/" class="btn text-lg uppercase"> <i class="fas fa-rocket mr-4 text-xl"></i> Pathfinder </a>
                <a href="/" class="btn text-lg uppercase"> <i class="fab fa-discord mr-4 text-xl"></i> Discord </a>
                <a href="/" class="btn text-lg uppercase"> <i class="fas fa-chart-line mr-4 text-xl"></i> Janice </a>
            </div>
            <!-- TOONS MANAGEMENT -->

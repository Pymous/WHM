    ...
    <AppLayout title="Dashboard">
        ...
        <div class="max-md:order-1 lg:w-5/12">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="https://help.fo2re.space/" class="btn text-lg uppercase"> <i class="fas fa-book mr-4 text-xl"></i> Guides </a>
                <a href="https://pf.fo2re.space/" class="btn text-lg uppercase"> <i class="fas fa-rocket mr-4 text-xl"></i> Pathfinder </a>
                <a :href="route('discord.auth.login')" class="btn text-lg uppercase"> <i class="fab fa-discord mr-4 text-xl"></i> Discord </a>
                <a href="https://janice.e-351.com" class="btn text-lg uppercase"> <i class="fas fa-chart-line mr-4 text-xl"></i> Janice </a>
            </div>
            <!-- TOONS MANAGEMENT -->
